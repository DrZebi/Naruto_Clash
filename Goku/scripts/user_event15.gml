...
initPatch("4.0", "25 September, 2024");
initSection("(by Ambi)");
initHeader("NSpecial - Nerfs");
initSection("Can no longer be angled up and down.");
initHeader("Jab - Adjustments");
initSection("Hitboxes adjusted.");
initSection("Horizontal speed reduced during subsequent hits.");
initSection("Jab 2 angle 361 --> 50.");
initHeader("FTilt - Nerfs");
initSection("Projectile hitstun multiplier 1.0 --> 0.7.");
initHeader("UTilt - Nerfs");
initSection("Hitbox size decreased.");
initSection("Stomp hitbox removed.");
initSection("Projectile base knockback 8 --> 6.");
initSection("Projectile hitstun multipler 1.0 --> 0.7.");
initHeader("DTilt - Nerfs");
initSection("Hitbox size decreased.");
initSection("Horizontal speed decreased.");
initHeader("DAttack - Nerfs");
initSection("Startup 10 --> 13.");
initSection("Horizontal speed decreased.");
initHeader("FAir - Adjustments");
initSection("Sourspot position adjusted.");
initHeader("BAir - Nerfs, Adjustments");
initSection("Hitbox size decreased.");
initSection("Base knockback 8 --> 7.");
initSection("Knockback growth 0.75 --> 0.8.");
initSection("Angle 140 --> 135.");
initHeader("UAir - Nerfs, Buffs, Adjustments");
initSection("Hitbox size adjusted.");
initSection("Angle flipper removed.");
initSection("Angle 80 --> 90.");
initSection("Damage 5 --> 7.");
initSection("Endlag 10 --> 13.");
initHeader("DAir - Nerfs, Buffs");
initSection("Startup 12 --> 15.");
initSection("Landing lag 10 --> 12.");
initSection("Endlag 4 --> 8.");
initSection("Bottom late hitbox removed.");
initSection("Spike active frames 2 --> 3.");
initSection("Spike angle 280 --> 270.");
initSection("Sourspot damage 11 --> 8.");
initHeader("FStrong - Nerfs");
initSection("Knockback growth (SSJ) 1.3 --> 1.15.");
initSection("Endlag 16 --> 24.");
initHeader("UStrong - Nerfs");
initSection("Hitbox size decreased.");
initSection("Physics adjusted during endlag.");
initSection("Endlag 20 --> 24.");
initSection("Knockback growth (SSJ) 1.3 --> 1.2.");
initSection("Now has 8 frames of landing lag instead of just continuing on the ground.");
initHeader("DStrong - Nerfs");
initSection("Sourspot size decreased.");

initPatch("3.0", "16 June, 2024");
