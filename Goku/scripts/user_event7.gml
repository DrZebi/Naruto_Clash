...
///////////////////////////////////////////
initCodecPage(0, 4, 9, "Woah, is that who I think it is?");
initCodecPage(1, 0, 1, "Pit what's--");
initCodecPage(1, 3, 6, "GASP!");
initCodecPage(2, 2, 8, "It's him!"); 
initCodecPage(1, 0, 2, "Son Goku."); 
initCodecPage(0, 4, 1, "The guy who fought a destroyer god?!"); 
initCodecPage(0, 5, 6, "What's he doing here?!"); 
initCodecPage(2, 0, 4, "Looking for a good fight, I suppose...");
initCodecPage(0, 9, 8, "I... don't like the sound of that.");
initCodecPage(2, 0, 2, "Y'know, all these saiyans do is fight and eat. They're worse than humans!");
initCodecPage(1, 0, 1, "Goku doesn't act like a saiyan though.");
initCodecPage(1, 0, 2, "He's pure of heart and very kind.");
initCodecPage(1, 2, 5, "Also, he's a bit naive... but his power speaks for itself.");
initCodecPage(0, 6, 6, "How can I beat someone that strong?");
initCodecPage(1, 0, 1, "Don't worry, Pit - it seems like whatever force brought him to Aether has weakened him.");
initCodecPage(0, 7, 5, "Then I'll have to take him down before he has time to recover!");
initCodecPage(1, 0, 2, "Good luck Pit!");
///////////////////////////////////////////
